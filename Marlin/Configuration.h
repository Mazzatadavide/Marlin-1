...
#define STRING_CONFIG_H_AUTHOR "(Matteo Perini, Stratasys Dimension config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Stratasys Dimension"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "d3fb36ed-d7db-40b0-9a61-8208e06b522e"
...
#define HOTEND_OFFSET_X {0.0, 2.0} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 122, 122, 1280, 1280} //250 
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 10, 1000} //25
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN     //decommenta questooooooooooooooo
 ...
 *
 */
#define Z_MIN_PROBE_ENDSTOP    //commenta questo############################################################################################
