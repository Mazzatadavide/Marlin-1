 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS 4 // Degrees Celsius1
  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD 250                // Seconds
  #define WATCH_BED_TEMP_INCREASE 1               // Degrees Celsius 60/ 1
#endif
